                        ...
                        (t.i = function (e, r, n, o, i) {
                            ...
                            for (var c = 0; c < e.length; c++) {
                                ...
                                (n && a[f[0]]) ||
                                    ...
                                    r &&
                                        (f[2]
                                            ? ((f[1] = '@media '.concat(f[2], ' {').concat(f[1], '}')), (f[2] = r))
                                            : (f[2] = r)),
                                    o &&
                                        (f[4]
                                            ? ((f[1] = '@supports ('.concat(f[4], ') {').concat(f[1], '}')), (f[4] = o))
                                            : (f[4] = ''.concat(o))),
                                    t.push(f));
                            }
                        }),
                    ...
                    var l = t.documentElement,
                        ...
                        p = (u.testStyles = function (e, r, n, a) {
                            ...
                            return (
                                ...
                                (u = r(p, e)),
                                h.fake
                                    ? (h.parentNode.removeChild(h), (l.style.overflow = f), l.offsetHeight)
                    ...
                    c.addTest('touchevents', function () {
                        ...
                        (function () {
                            ...
                            for (var f in s)
                                if (s.hasOwnProperty(f)) {
                                    ...
                                    for (o = n(t.fn, 'function') ? t.fn() : t.fn, i = 0; i < e.length; i++)
                        ...
                        (function (e) {
                            ...
                            c._config.enableClasses &&
                                ((t += ' ' + r + e.join(' ' + r)), d ? (l.className.baseVal = t) : (l.className = t));
                        })(a),
                        delete u.addTest,
    ...
    (() => {
        ...
        function T(e, t, r) {
            return function () {
                for (var n = [], o = 0, i = e, a = 0; a < t.length || o < arguments.length; ) {
                    var s;
                    a < t.length && (!m(t[a]) || o >= arguments.length) ? (s = t[a]) : ((s = arguments[o]), (o += 1)),
                        (n[a] = s),
                        m(s) || (i -= 1),
                        (a += 1);
                }
            ...
            switch (a) {
                ...
                case 'Object':
                    if (
                        ...
                        'Promise' ===
                            ((o = e.constructor), null == (i = String(o).match(/^function (\w*)/)) ? '' : i[1])
                    )
                        return e === t;
                    break;
                case 'Boolean':
        ...
        var ne = (function () {
            ...
            return (
                ...
                (e.prototype['@@transducer/result'] = function (e) {
                    return (
                        this.found || (e = this.xf['@@transducer/step'](e, void 0)), this.xf['@@transducer/result'](e)
                    );
                }),
                (e.prototype['@@transducer/step'] = function (e, t) {
                    return (
                        this.f(t) &&
                            ((this.found = !0),
                            (e =
                                (r = this.xf['@@transducer/step'](e, t)) && r['@@transducer/reduced']
                                    ? r
            ...
            if ((console.log(e), (e = new se(e)), !Modernizr.touchevents)) {
                ...
                var h = () => {
                    r &&
                        ...
                        (r.style.height = a + 'px')),
                        o &&
                            (o.style.transform = 'matrix(1, 0, 0, 1, ' + l + ', ' + d + ') translate3d(-50%, -50%, 0)'),
